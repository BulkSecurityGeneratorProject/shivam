...
import org.shivam.domain.AgentMaster;
import org.shivam.repository.AgentMasterRepository;
import org.shivam.service.AgentMasterService;
import org.shivam.service.dto.AgentMasterDTO;
import org.shivam.service.mapper.AgentMasterMapper;
...
import static org.shivam.web.rest.TestUtil.createFormattingConversionService;
...
public class AgentMasterResourceIntTest extends AbstractCassandraTest {
    ...
    public void createAgentMaster() throws Exception {
        ...
        assertThat(testAgentMaster.getAgentNo()).isEqualTo(DEFAULT_AGENT_NO);
    ...
    public void updateAgentMaster() throws Exception {
        ...
        AgentMaster testAgentMaster = agentMasterList.get(agentMasterList.size() - 1);
        assertThat(testAgentMaster.getAgentNo()).isEqualTo(UPDATED_AGENT_NO);
